# This is just WRONG. I need to modify rhs evaluation to modify y to do the frame transform, qutip/dynamiqs doesn't have rhs exposure.
...
#         Ucols = np.column_stack([ket for ket in frame_basis])
...
#             out = self.out_of_frame_basis(qutip.Qobj(out))
#         return out
