# When I first tried qiskit in Feb 18 2024. I wrote this was to divide a long simulation into chunks because somehow qiskit dynamics tries to reserve huge amount of VRAM. Maybe it was user error.
